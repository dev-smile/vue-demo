...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        ...
        ({}({}));
        const __VLS_9 = __VLS_pickFunctionalComponentCtx(DocumentationIcon, __VLS_6);
    }
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        (__VLS_4.slots).heading;
    }
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        ...
        ({}({}));
        const __VLS_19 = __VLS_pickFunctionalComponentCtx(ToolingIcon, __VLS_16);
    }
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        (__VLS_14.slots).heading;
    }
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        ...
        ({}({}));
        const __VLS_29 = __VLS_pickFunctionalComponentCtx(EcosystemIcon, __VLS_26);
    }
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        (__VLS_24.slots).heading;
    }
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        ...
        ({}({}));
        const __VLS_39 = __VLS_pickFunctionalComponentCtx(CommunityIcon, __VLS_36);
    }
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        (__VLS_34.slots).heading;
    }
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        ...
        ({}({}));
        const __VLS_49 = __VLS_pickFunctionalComponentCtx(SupportIcon, __VLS_46);
    }
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        (__VLS_44.slots).heading;
    }
